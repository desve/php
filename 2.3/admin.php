...
<form method="POST" enctype="multipart/form-data" name="myForm">
    ...
    <input type="file" name="test_1" accept="json">
    <input type="file" name="test_2" accept="json">
    <input type="file" name="test_3" accept="json">
    <input type="file" name="test_4" accept="json">
    <input type="file" name="test_5" accept="json">
