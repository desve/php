<?php header('Content-Type: text/html; charset=utf-8');
    ...
    $ACTUAL_TIME = 1;  
    // Проверяем существование файла weather.json и его актуальность
    $fileName = 'weather.json';
    if (file_exists($fileName) and lastUpdateTime($fileName, $ACTUAL_TIME)) {
        ...
        echo "Файл {$fileName} НЕ существует или НЕ актуален. ";
        // Получаем актуальную информацию
        $climate = getActualWeather($city, $fileName);
    }
